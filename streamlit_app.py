...
# UI STYLE
# ============================================================
# Keep Streamlit default styling for better readability and consistency.
...
def main():
    ...
    with tab2:
        ...
        st.info("Upload a CSV file to summarize multiple texts at once.")
        st.markdown(
            """
...
Column names are case-insensitive and detected automatically.
            """
        )
